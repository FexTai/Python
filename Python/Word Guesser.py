# Random für das Aussuchen eines Wortes
import sys
import random
...
word = random.choice(words)  # Zufällige Auswahl eines Wortes aus der Datenbank
while "-" in word or " " in word:  # Vermeidung von unerwünschten Zeichen in dem Wort
    word = random.choice(words)

print("")
print("Welcome to the word guesser!")
print("")
print("The programm is going to generate a random word and tell you the first and the remaining letters")
print("")
print("The first letters of the word are:")

# Initialisierung
wle = len(word) - 1
anz = len(word) // 2
le = -1
rem = len(word) - anz  # rem für remaining

# Die ersten Buchstaben des Wortes
for x in range(0, anz):
    le += 1
    print(word[le], end="")
...
# Initialisierung 2 (für das eigentlcihe raten)
trials = 1
rev = 0
ans = input("You can now start guessing:").lower()


while ans != word:  # while Schleife als Spielbasis
    trials += 1
    ans = input("Try again!:")
    if trials == 5:  # If verkettung für das Zählen der reveals
        anz = 1
        rev += 1
        for x in range(0, anz):
                le += 1
                print("the next letter is:", word[le])
        if le == wle:  # Falls das Wort vollständig enthüllt wird
            print("")
            print("All characters have been revealed! The word was:", word, " │  you have tried", trials, "times!")
            print("")
            print("Sorry but you have lost! Rerun the programm and try again")
            sys.exit()
        ...
        for x in range(0, anz):
            le += 1
            print("the next letter is:", word[le])
        if le == wle:  # Falls das Wort vollständig enthüllt wird x4 für alle reveal Schleifen
            print("")
            print("All characters have been revealed! The word was:", word, " │  you have tried", trials, "times!")
            print("")
            print("Sorry but you have lost! Rerun the programm and try again")
...
print("")
print("You have successfully guessed the word! It took you:", trials, "attempts and you needed", rev, "out of 4 letter reveals!")
